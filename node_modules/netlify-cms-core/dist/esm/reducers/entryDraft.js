    ...
    case _entries.DRAFT_CHANGE_FIELD:
      {
        return state.withMutations(state => {
          ...
          state.set('hasChanged', !entries.some(e => newData.equals(e.get('data'))) || !entries.some(e => newMeta.equals(e.get('meta'))));
        });
      }
...
const selectCustomPath = (collection, entryDraft) => {
  ...
  const customPath = path && (0, _path.join)(collection.get('folder'), path, "".concat(indexFile, ".").concat(extension));
  return customPath;
};
